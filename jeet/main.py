"""Tier 1-2-4-5: a plain-text conversation loop with tool use, memory
loaded at startup, and a background heartbeat.
...
notices) and weave the result into its answer. Ctrl+D / Ctrl+C / "exit" /
"quit" to leave.
"""
